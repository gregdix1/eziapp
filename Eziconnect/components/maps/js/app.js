 ...
 // setBearing = positionHng;
  ...
  function setNightmode(on) {
    ...
    if (on) {
        ...
        statusBar.classList.add("statusNight");
    } else {
        btnNightmode.classList.remove("active");
        statusBar.classList.remove("statusNight");
    }
  ...
  function openMap() {
     // alert(positionCurrent.lat + "," + positionCurrent.lng);
      map.flyTo({ center: [positionCurrent.lng, positionCurrent.lat]});
